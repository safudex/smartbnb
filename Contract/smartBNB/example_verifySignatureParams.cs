...
namespace Neo.SmartContract
{
    public class HelloWorld : Framework.SmartContract
    {
        ...
        public static bool Main(params object[] args)
        {
			...
			BigInteger x = (BigInteger)args[0];//byteX.AsBigInteger();
			...
			BigInteger y = (BigInteger)args[1];//byteY.AsBigInteger();
			byte[] compressed = (byte[])args[2];;//{211, 118, 157, 138, 31, 120, 180, 193, 122, 150, 95, 122, 48, 212, 24, 31, 171, 189, 31, 150, 159, 70, 211, 200, 232, 59, 90, 212, 132, 84, 33, 216};
			...
			BigInteger s_x = (BigInteger)args[3];//s_byteX.AsBigInteger();
			...
			BigInteger s_y = (BigInteger)args[4];//s_byteY.AsBigInteger();
			byte[] s_compressed = (byte[])args[5];//{136, 84, 7, 10, 193, 124, 106, 237, 245, 30, 100, 79, 104, 197, 97, 49, 94, 178, 74, 123, 70, 238, 97, 41, 185, 127, 141, 244, 173, 87, 115, 91};
            
            int ini = 1;
            int fin = (int)args[6];//1488;
            
            byte[] msg = (byte[])args[7];//{0x88, 0x54, 0x7, 0xa, 0xc1, 0x7c, 0x6a, 0xed, 0xf5, 0x1e, 0x64, 0x4f, 0x68, 0xc5, 0x61, 0x31, 0x5e, 0xb2, 0x4a, 0x7b, 0x46, 0xee, 0x61, 0x29, 0xb9, 0x7f, 0x8d, 0xf4, 0xad, 0x57, 0x73, 0x5b, 0xd3, 0x76, 0x9d, 0x8a, 0x1f, 0x78, 0xb4, 0xc1, 0x7a, 0x96, 0x5f, 0x7a, 0x30, 0xd4, 0x18, 0x1f, 0xab, 0xbd, 0x1f, 0x96, 0x9f, 0x46, 0xd3, 0xc8, 0xe8, 0x3b, 0x5a, 0xd4, 0x84, 0x54, 0x21, 0xd8, 0x79, 0x8, 0x2, 0x11, 0x9c, 0x5, 0xff, 0x2, 0x0, 0x0, 0x0, 0x0, 0x22, 0x48, 0xa, 0x20, 0xdf, 0x47, 0xf7, 0x85, 0x7b, 0x58, 0x28, 0xe3, 0x93, 0xf9, 0x5f, 0xe7, 0xdd, 0xca, 0x2a, 0x83, 0xd5, 0x81, 0xc4, 0xca, 0x9b, 0xb8, 0x47, 0x3d, 0xba, 0xc0, 0x75, 0x87, 0x18, 0x5d, 0x41, 0xf8, 0x12, 0x24, 0xa, 0x20, 0xb, 0xc9, 0xa9, 0x70, 0x61, 0xef, 0xe7, 0x2b, 0x48, 0xd3, 0xc1, 0xa3, 0xaa, 0x15, 0xab, 0x54, 0x5, 0xf5, 0x2b, 0x23, 0x3e, 0x7f, 0x62, 0x7f, 0x8, 0x6f, 0x2b, 0xc1, 0x8c, 0xd2, 0x87, 0xe4, 0x10, 0x1, 0x2a, 0xc, 0x8, 0xb6, 0xef, 0xe1, 0xee, 0x5, 0x10, 0x8d, 0xd6, 0xce, 0xec, 0x1, 0x32, 0x14, 0x42, 0x69, 0x6e, 0x61, 0x6e, 0x63, 0x65, 0x2d, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x2d, 0x54, 0x69, 0x67, 0x72, 0x69, 0x73};
            ...
            byte[] hash = (byte[])args[9];//{0xdf, 0x47, 0xf7, 0x85, 0x7b, 0x58, 0x28, 0xe3, 0x93, 0xf9, 0x5f, 0xe7, 0xdd, 0xca, 0x2a, 0x83, 0xd5, 0x81, 0xc4, 0xca, 0x9b, 0xb8, 0x47, 0x3d, 0xba, 0xc0, 0x75, 0x87, 0x18, 0x5d, 0x41, 0xf8};
            byte[] sbytes = (byte[])args[8];//{0xcf, 0x41, 0x33, 0x8f, 0xc2, 0x18, 0xd3, 0x7b, 0x2a, 0x63, 0x6e, 0xdc, 0x83, 0xee, 0x63, 0xe1, 0x4f, 0x6c, 0x0c, 0x4e, 0x14, 0x9a, 0x8f, 0x05, 0x73, 0xe4, 0x8d, 0x70, 0x12, 0xab, 0x15, 0x0d};

            Storage.Put("v", verify_signature(x, y, compressed, sbytes, s_compressed, s_x, s_y, pre, msg, hash)?"true":"false");
            
			return false;
        }
        
        private static bool verify_signature(BigInteger A0_xPubK, BigInteger A1_yPubK, byte[] pubK, byte[] s_signatureLow,
            byte[] Rs_signatureHigh, BigInteger R0_xSigHigh, BigInteger R1_ySigHigh, ulong[] pre, byte[] signBytes, byte[] blockHash){
            ...
            if (!checkBytes(pre, signBytes, 1, pre[pre.Length-1])){
