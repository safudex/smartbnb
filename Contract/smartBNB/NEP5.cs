...
namespace NEP5
{
    public class NEP5 : SmartContract
    {
		...
		private static BigInteger updateAmount(BigInteger amount, BigInteger lastTransfer, BigInteger currentTime){
			...
			magnitude /= 2;
			if(deltaTime >= magnitude){
				byte[] rateNumeratorBytes = {0x4c, 0x0c, 0x4c, 0x24, 0xd6, 0x27, 0x67, 0x8d, 0x10, 0x52, 0x2b, 0x30, 0x00, 0xbd, 0xce, 0xc4, 0x3d, 0x5b, 0x09, 0xa5, 0x03, 0xf9, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
				BigInteger rateNumerator = rateNumeratorBytes.AsBigInteger();
				amount = (amount * rateNumerator) / rateDenominator;
				deltaTime -= magnitude;
			}
